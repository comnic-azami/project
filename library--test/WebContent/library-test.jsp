...
<div id="content">
	...
	<select name="" id="isbn_list" size=2>
		<option value="4047916234,4103534222,4103534230,4103534257" selected>4047916234,4103534222,4103534230,4103534257</option>
		<option value="4088700104,4334926940">4088700104,4334926940</option>
	</select>
...
<div style="margin-top: 30px;">
	<hr size="1">
	<a href="/doc/api_jsref.html">>>カーリル図書館API JSライブラリ仕様書</a>
</div>
